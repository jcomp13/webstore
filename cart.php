                  ...
                  <div class="modal-body">
				     <div class="row">
                      <form action="thankYou.php" method="post" id="payment-form">
					   ...
					   <input type="hidden" name="description" value="<?=$item_count . ' item'. (($item_count>1)?'s':'') . ' from Jeffs Store';?>">
						...
						<div id ="step2" style="display:none;">
						   <div class="form-group col-md-3">
						      <!--  no name include so the information is not sent to my server  -->
...
<script>
  ...
  function check_address() {
	  var data = {
        ...
        jQuery.ajax({
			url : '/teststore/admin/parsers/check_address.php',
			method : 'POST',
			data : data,
...
//  };
 ...
 // Create a p
 // payment form is the id of the pages form
 //  disable the submit button and then return false to avoid going to Thank you until response is returned.
 //jQuery(function($){
