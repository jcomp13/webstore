<?php
 //  $db=mysqli_connect("localhost","jerseyshoreuser","Rockybear13","jerseyshoreuser");
 ...
 //require_once  $_SERVER["DOCUMENT_ROOT"].'/ecomm4/econfig.php';   // this is what they defined
